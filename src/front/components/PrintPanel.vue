<template>
  <div :class="['print-panel', `print-panel--${variant}`]">
    <select
      :value="modelValue"
      class="print-panel__select"
      @change="emit('update:modelValue', ($event.target as HTMLSelectElement).value as DitherAlgorithm)"
    >
...
<script setup lang="ts">
  ...
  const emit = defineEmits<{
    'update:modelValue': [value: DitherAlgorithm]
    confirm: []
    cancel: []
  }>()
</script>
